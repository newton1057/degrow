...
By accessing and using DeGrow ("the App"), you accept and agree to be bound by the terms and provisions of this agreement.

## 2. Description of Service

DeGrow is a habit tracking application that helps users build and maintain positive habits through:
...
### 4.1 Your Data
- You retain all rights to the habit data and content you create in the App
...
- We provide export functionality to help you backup your data
...
### 6.1 App Ownership
- The App, including its design, code, and content, is owned by DeGrow
...
### 7.1 Free Service
- DeGrow is currently offered as a free service
- We reserve the right to introduce paid features in the future

### 7.2 Future Paid Features
- If we introduce paid features, we will provide clear pricing information
...
- DeGrow is a productivity tool, not medical advice
- Consult healthcare professionals for medical or mental health concerns
- We are not responsible for any health-related decisions you make
...
- Email: legal@degrow.app
- Website: https://degrow.app/contact
...
These terms constitute the entire agreement between you and DeGrow regarding the use of the App.

---

**By using DeGrow, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions.**
