...
const translations = {
  en: {
    ...
    landing: {
      ...
      feature3Description: 'Understand your patterns with detailed progress analytics and streaks.',
      ...
      testimonialsTitle: 'Loved by Thousands of Users',
      testimonial1Quote: 'DeGrow transformed how I approach my daily routine. The visual tracking keeps me motivated every single day.',
      testimonial1Author: 'Sarah Johnson',
      testimonial1Role: 'Product Designer',
      testimonial2Quote: 'Finally, a habit tracker that\'s both beautiful and functional. The weekly view is a game-changer.',
      testimonial2Author: 'Michael Chen',
      testimonial2Role: 'Software Engineer',
      testimonial3Quote: 'I\'ve tried many habit apps, but DeGrow\'s simplicity and design make it the one I actually use daily.',
      testimonial3Author: 'Emma Williams',
      testimonial3Role: 'Entrepreneur',
      ctaTitle: 'Ready to Transform Your Life?',
      ctaSubtitle: 'Join thousands of users building better habits with DeGrow.',
    ...
    privacy: {
      ...
      feature3: 'No tracking or analytics without your consent',
  ...
  es: {
    ...
    landing: {
      ...
      feature3Title: 'Análisis Semanal',
      feature3Description: 'Comprende tus patrones con análisis detallados de progreso y rachas.',
      ...
      testimonialsTitle: 'Amado por Miles de Usuarios',
      testimonial1Quote: 'DeGrow transformó cómo abordo mi rutina diaria. El seguimiento visual me mantiene motivada cada día.',
      testimonial1Author: 'Sarah Johnson',
      testimonial1Role: 'Diseñadora de Producto',
      testimonial2Quote: 'Finalmente, un rastreador de hábitos que es hermoso y funcional. La vista semanal es revolucionaria.',
      testimonial2Author: 'Michael Chen',
      testimonial2Role: 'Ingeniero de Software',
      testimonial3Quote: 'He probado muchas apps de hábitos, pero la simplicidad y diseño de DeGrow la hacen la que uso diariamente.',
      testimonial3Author: 'Emma Williams',
      testimonial3Role: 'Emprendedora',
      ctaTitle: '¿Listo para Transformar tu Vida?',
      ctaSubtitle: 'Únete a miles de usuarios construyendo mejores hábitos con DeGrow.',
    ...
    privacy: {
      ...
      feature3: 'Sin rastreo ni analíticas sin tu consentimiento',
